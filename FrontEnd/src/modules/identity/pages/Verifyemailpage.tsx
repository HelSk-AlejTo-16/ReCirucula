      ...
      <div style={styles.card}>
        ...
        {status === 'error' && (
          <>
            ...
            <p style={styles.text}>
              El enlace puede haber expirado (válido 24 h) o ya fue usado.
            </p>
        ...
        {status === 'missing' && (
          <>
            ...
            <p style={styles.text}>
              No encontramos un token de verificación en esta URL. Usa el enlace
              que recibiste en tu correo electrónico.
            </p>
